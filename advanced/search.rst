...
With EasyGo Solutions, you can limit your search to specific attributes.
...
.. hint::
   ...
   :docs:`EasyGo Solutions System Documentation </install/elasticsearch/indexed-attributes.html>`.
...
.. csv-table:: Attributes and their usage
   ...
   "title", "some title", "title:""some title"" |br|\ title:Printer |br|\ title: ""some ti*""", "If you need to use spaces in the search phrase, use quotes. EasyGo Solutions will do an AND-search over the given words. You can also use a single keyword without quotation."
...
.. csv-table:: Examples for search phrase combinations
   ...
   "state.name:(closed OR open) AND (priority.name:""2 normal"" OR tags:feedback) AND !(*EasyGo Solutions*)", "This gets the same result as above, expect that we don't want the ticket to contain anything matching to ""EasyGo Solutions""."
